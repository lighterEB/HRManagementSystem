...
public partial class LoginView : UserControl
{
    public LoginView()
    {
        ...
        // 初始化后获取控件并添加事件处理
        this.AttachedToVisualTree += LoginView_AttachedToVisualTree;
    }

    private void LoginView_AttachedToVisualTree(object? sender, Avalonia.VisualTreeAttachmentEventArgs e)
    {
        // 控件完全加载后再获取引用，确保能找到
