...
public partial class RegisterView : UserControl
{
    public RegisterView()
    {
        ...
        this.AttachedToVisualTree += RegisterView_AttachedToVisualTree;
    }

    private void RegisterView_AttachedToVisualTree(object? sender, Avalonia.VisualTreeAttachmentEventArgs e)
    {
